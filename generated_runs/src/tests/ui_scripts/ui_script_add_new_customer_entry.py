...
_PROJECT_ROOT = _Path("C:\\Users\\rswap\\OneDrive\\Desktop\\project\\testify-automator-ai\\backend\\organizations\\manoj\\144-bank") if "C:\\Users\\rswap\\OneDrive\\Desktop\\project\\testify-automator-ai\\backend\\organizations\\manoj\\144-bank" else None
...
RUN_TAGS = {
    "TS_002_TC_001_add_new_customer_entry_positive": [
        "regression"
    ],
    "TS_002_TC_002_add_new_customer_entry_negative": [
        "functional"
    ],
    "TS_002_TC_003_add_new_customer_entry_edge": [
        "functional"
    ]
}

@pytest.mark.regression
def TS_002_TC_001_add_new_customer_entry_positive():
    import time
    import os
    from pathlib import Path as _Path
...
def TS_002_TC_002_add_new_customer_entry_negative():
    import time
    import os
    from pathlib import Path as _Path
    with sync_playwright() as p:
...
@pytest.mark.functional
def TS_002_TC_003_add_new_customer_entry_edge():
    import time
    import os
    from pathlib import Path as _Path
    with sync_playwright() as p:
...
if __name__ == '__main__':
    ...
    failures = 0
    if _should_run('TS_002_TC_001_add_new_customer_entry_positive'):
        try:
            print(f'\n[ui_runner] Running test: TS_002_TC_001_add_new_customer_entry_positive...\n')
            run_allure_case('TS_002_TC_001_add_new_customer_entry_positive', TS_002_TC_001_add_new_customer_entry_positive)
            print(f'\n[ui_runner] TS_002_TC_001_add_new_customer_entry_positive: PASS\n')
        except Exception as exc:
            failures += 1
            print(f'\n[ui_runner] TS_002_TC_001_add_new_customer_entry_positive: FAIL\nDetails: {exc}\n')
    else:
        print(f'\n[ui_runner] Skipping TS_002_TC_001_add_new_customer_entry_positive (tag filter)\n')
    if _should_run('TS_002_TC_002_add_new_customer_entry_negative'):
        try:
            print(f'\n[ui_runner] Running test: TS_002_TC_002_add_new_customer_entry_negative...\n')
            run_allure_case('TS_002_TC_002_add_new_customer_entry_negative', TS_002_TC_002_add_new_customer_entry_negative)
            print(f'\n[ui_runner] TS_002_TC_002_add_new_customer_entry_negative: PASS\n')
        except Exception as exc:
            failures += 1
            print(f'\n[ui_runner] TS_002_TC_002_add_new_customer_entry_negative: FAIL\nDetails: {exc}\n')
    else:
        print(f'\n[ui_runner] Skipping TS_002_TC_002_add_new_customer_entry_negative (tag filter)\n')
    if _should_run('TS_002_TC_003_add_new_customer_entry_edge'):
        try:
            print(f'\n[ui_runner] Running test: TS_002_TC_003_add_new_customer_entry_edge...\n')
            run_allure_case('TS_002_TC_003_add_new_customer_entry_edge', TS_002_TC_003_add_new_customer_entry_edge)
            print(f'\n[ui_runner] TS_002_TC_003_add_new_customer_entry_edge: PASS\n')
        except Exception as exc:
            failures += 1
            print(f'\n[ui_runner] TS_002_TC_003_add_new_customer_entry_edge: FAIL\nDetails: {exc}\n')
    else:
        print(f'\n[ui_runner] Skipping TS_002_TC_003_add_new_customer_entry_edge (tag filter)\n')
