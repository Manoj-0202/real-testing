...
def enter_search_customers_loans_transactions(page, value):
    page.smartAI('bank_customer_search_customers_loans_transactions_textbox_search_customers_loans_transactions_field').fill(str(value))
...
def verify_bank_crm_visible(page):
    expect(page.smartAI('bank_customer_bank_crm_label_bank_crm_info')).to_be_visible()
...
def enter_search_customers(page, value):
    page.smartAI('bank_customer_search_customers_textbox_search_customers_field').fill(str(value))
...
def click_add_new_customer(page):
    page.smartAI('bank_customer_add_new_customer_button_add_new_customer_action').click()
