...
def select_select_origin(page, value):
    try:
        page.smartAI('secnd_select_origin_select_select_origin_select').select_option(value)
        return
    except Exception:
        pass
    _select_by_label(page, 'Select Origin', value)
    raise RuntimeError(f"Unable to select {value!r} for: 'Select Origin'")

def assert_select_select_origin_visible(page, timeout: int = 6000):
    expect(page.smartAI('secnd_select_origin_select_select_origin_select')).to_be_visible(timeout=timeout)


def select_indian(page, value):
    try:
        page.smartAI('secnd_indian_select_indian_select').select_option(value)
        return
    except Exception:
        pass
    _select_by_label(page, 'INDIAN', value)
    raise RuntimeError(f"Unable to select {value!r} for: 'INDIAN'")

def assert_select_indian_visible(page, timeout: int = 6000):
    expect(page.smartAI('secnd_indian_select_indian_select')).to_be_visible(timeout=timeout)


def select_foreigner(page, value):
    try:
        page.smartAI('secnd_foreigner_select_foreigner_select').select_option(value)
        return
    except Exception:
        pass
    _select_by_label(page, 'FOREIGNER', value)
    raise RuntimeError(f"Unable to select {value!r} for: 'FOREIGNER'")

def assert_select_foreigner_visible(page, timeout: int = 6000):
    expect(page.smartAI('secnd_foreigner_select_foreigner_select')).to_be_visible(timeout=timeout)


def select_saarc(page, value):
    try:
        page.smartAI('secnd_saarc_select_saarc_select').select_option(value)
        return
    except Exception:
        pass
    _select_by_label(page, 'SAARC', value)
    raise RuntimeError(f"Unable to select {value!r} for: 'SAARC'")

def assert_select_saarc_visible(page, timeout: int = 6000):
    expect(page.smartAI('secnd_saarc_select_saarc_select')).to_be_visible(timeout=timeout)


def select_bimstec(page, value):
    try:
        page.smartAI('secnd_bimstec_select_bimstec_select').select_option(value)
        return
    except Exception:
        pass
    _select_by_label(page, 'BIMSTEC', value)
    raise RuntimeError(f"Unable to select {value!r} for: 'BIMSTEC'")

def assert_select_bimstec_visible(page, timeout: int = 6000):
    expect(page.smartAI('secnd_bimstec_select_bimstec_select')).to_be_visible(timeout=timeout)


def select_select_country(page, value):
    try:
        page.smartAI('secnd_select_country_select_select_country_select').select_option(value)
        return
    except Exception:
        pass
    _select_by_label(page, 'Select Country', value)
    raise RuntimeError(f"Unable to select {value!r} for: 'Select Country'")

def assert_select_select_country_visible(page, timeout: int = 6000):
    expect(page.smartAI('secnd_select_country_select_select_country_select')).to_be_visible(timeout=timeout)


def enter_01(page, value):
    try:
        _enter_value(page, '01', value, placeholder='01')
        return
    except Exception:
        pass
    try:
        locator = page.smartAI('secnd_01_textbox_01_field')
        locator.click()
        try:
            locator.clear()
        except Exception:
        ...
        pass
    raise RuntimeError(f"Unable to enter value for: '01'")
...
def assert_enter_01(page, expected: str, timeout: int = 6000):
    ...
    try:
        ...
        if not _values_match(actual, str(expected)):
            raise AssertionError(f"Assertion failed for 'secnd_01_textbox_01_field' expecting '{str(expected)}' but got '{actual}': {e}")


def assert_enter_01_visible(page, timeout: int = 6000):
    expect(page.smartAI('secnd_01_textbox_01_field')).to_be_visible(timeout=timeout)


def enter_00(page, value):
    try:
        _enter_value(page, '00', value, placeholder='00')
        return
    except Exception:
        pass
    try:
        locator = page.smartAI('secnd_00_textbox_00_field')
        locator.click()
        try:
            locator.clear()
        except Exception:
        ...
        pass
    raise RuntimeError(f"Unable to enter value for: '00'")
...
def assert_enter_00(page, expected: str, timeout: int = 6000):
    ...
    try:
        ...
        actual = _safe_input_value(locator)
        if not _values_match(actual, str(expected)):
            raise AssertionError(f"Assertion failed for 'secnd_00_textbox_00_field' expecting '{str(expected)}' but got '{actual}': {e}")


def assert_enter_00_visible(page, timeout: int = 6000):
    expect(page.smartAI('secnd_00_textbox_00_field')).to_be_visible(timeout=timeout)


def enter_name(page, value):
    try:
        _enter_value(page, 'Name', value, placeholder='Name')
        return
    except Exception:
        pass
    try:
        locator = page.smartAI('secnd_name_textbox_name_field')
        locator.click()
        try:
            locator.clear()
        except Exception:
        ...
        pass
    raise RuntimeError(f"Unable to enter value for: 'Name'")
...
def assert_enter_name(page, expected: str, timeout: int = 6000):
    ...
    try:
        ...
        actual = _safe_input_value(locator)
        if not _values_match(actual, str(expected)):
            raise AssertionError(f"Assertion failed for 'secnd_name_textbox_name_field' expecting '{str(expected)}' but got '{actual}': {e}")


def assert_enter_name_visible(page, timeout: int = 6000):
    expect(page.smartAI('secnd_name_textbox_name_field')).to_be_visible(timeout=timeout)
...
def enter_email(page, value):
    try:
        ...
        pass
    try:
        locator = page.smartAI('secnd_email_textbox_email_field')
        locator.click()
        try:
            locator.clear()
        except Exception:
...
def assert_enter_email(page, expected: str, timeout: int = 6000):
    ...
    try:
        ...
        actual = _safe_input_value(locator)
        if not _values_match(actual, str(expected)):
            raise AssertionError(f"Assertion failed for 'secnd_email_textbox_email_field' expecting '{str(expected)}' but got '{actual}': {e}")


def assert_enter_email_visible(page, timeout: int = 6000):
    expect(page.smartAI('secnd_email_textbox_email_field')).to_be_visible(timeout=timeout)


def enter_age(page, value):
    try:
        _enter_value(page, 'Age', value, placeholder='Age')
        return
    except Exception:
        pass
    try:
        locator = page.smartAI('secnd_age_textbox_age_field')
        locator.click()
        try:
            locator.clear()
        except Exception:
        ...
        pass
    raise RuntimeError(f"Unable to enter value for: 'Age'")
...
def assert_enter_age(page, expected: str, timeout: int = 6000):
    ...
    try:
        ...
        actual = _safe_input_value(locator)
        if not _values_match(actual, str(expected)):
            raise AssertionError(f"Assertion failed for 'secnd_age_textbox_age_field' expecting '{str(expected)}' but got '{actual}': {e}")


def assert_enter_age_visible(page, timeout: int = 6000):
    expect(page.smartAI('secnd_age_textbox_age_field')).to_be_visible(timeout=timeout)


def select_male(page, value):
    try:
        page.smartAI('secnd_male_select_male_select').select_option(value)
        return
    except Exception:
        pass
    _select_by_label(page, 'Male', value)
    raise RuntimeError(f"Unable to select {value!r} for: 'Male'")

def assert_select_male_visible(page, timeout: int = 6000):
    expect(page.smartAI('secnd_male_select_male_select')).to_be_visible(timeout=timeout)


def select_female(page, value):
    try:
        page.smartAI('secnd_female_select_female_select').select_option(value)
        return
    except Exception:
        pass
    _select_by_label(page, 'Female', value)
    raise RuntimeError(f"Unable to select {value!r} for: 'Female'")

def assert_select_female_visible(page, timeout: int = 6000):
    expect(page.smartAI('secnd_female_select_female_select')).to_be_visible(timeout=timeout)


def select_others(page, value):
    try:
        page.smartAI('secnd_others_select_others_select').select_option(value)
        return
    except Exception:
        pass
    _select_by_label(page, 'Others', value)
    raise RuntimeError(f"Unable to select {value!r} for: 'Others'")

def assert_select_others_visible(page, timeout: int = 6000):
    expect(page.smartAI('secnd_others_select_others_select')).to_be_visible(timeout=timeout)


def select_country_code(page, value):
    try:
        page.smartAI('secnd_country_code_select_country_code_select').select_option(value)
        return
    except Exception:
        pass
    _select_by_label(page, 'Country Code', value)
    raise RuntimeError(f"Unable to select {value!r} for: 'Country Code'")

def assert_select_country_code_visible(page, timeout: int = 6000):
    expect(page.smartAI('secnd_country_code_select_country_code_select')).to_be_visible(timeout=timeout)


def enter_mobile_no(page, value):
    try:
        _enter_value(page, 'Mobile No', value, placeholder='Mobile No')
        return
    except Exception:
        pass
    try:
        locator = page.smartAI('secnd_mobile_no_textbox_mobile_no_field')
        locator.click()
        try:
            locator.clear()
        except Exception:
        ...
        pass
    raise RuntimeError(f"Unable to enter value for: 'Mobile No'")
...
def assert_enter_mobile_no(page, expected: str, timeout: int = 6000):
    ...
    try:
        ...
        actual = _safe_input_value(locator)
        if not _values_match(actual, str(expected)):
            raise AssertionError(f"Assertion failed for 'secnd_mobile_no_textbox_mobile_no_field' expecting '{str(expected)}' but got '{actual}': {e}")


def assert_enter_mobile_no_visible(page, timeout: int = 6000):
    expect(page.smartAI('secnd_mobile_no_textbox_mobile_no_field')).to_be_visible(timeout=timeout)


def click_refund_policy(page):
    try:
        page.get_by_role("button", name='Refund Policy', exact=True).first.click()
        return
    except Exception:
        pass
    try:
        page.get_by_role("link", name='Refund Policy', exact=True).first.click()
        return
    except Exception:
        pass
    try:
        page.smartAI('secnd_refund_policy_link_refund_policy_action').click()
        return
    except Exception:
        pass
    _click_by_label(page, 'Refund Policy')

def assert_click_refund_policy_visible(page, timeout: int = 6000):
    expect(page.smartAI('secnd_refund_policy_link_refund_policy_action')).to_be_visible(timeout=timeout)


def click_privacy_policy(page):
    try:
        page.get_by_role("button", name='Privacy Policy', exact=True).first.click()
        return
    except Exception:
        pass
    try:
        page.get_by_role("link", name='Privacy Policy', exact=True).first.click()
        return
    except Exception:
        pass
    try:
        page.smartAI('secnd_privacy_policy_link_privacy_policy_action').click()
        return
    except Exception:
        pass
    _click_by_label(page, 'Privacy Policy')

def assert_click_privacy_policy_visible(page, timeout: int = 6000):
    expect(page.smartAI('secnd_privacy_policy_link_privacy_policy_action')).to_be_visible(timeout=timeout)
...
def click_help_contact(page):
    ...
    try:
        ...
        pass
    try:
        page.smartAI('secnd_help_contact_button_help_contact_action').click()
        return
    except Exception:
        pass
...
def assert_click_help_contact_visible(page, timeout: int = 6000):
    expect(page.smartAI('secnd_help_contact_button_help_contact_action')).to_be_visible(timeout=timeout)


def click_close_icon(page):
    try:
        page.get_by_role("button", name='close icon', exact=True).first.click()
        return
    except Exception:
        pass
    try:
        page.get_by_role("link", name='close icon', exact=True).first.click()
        return
    except Exception:
        pass
    try:
        page.smartAI('secnd_close_icon_iconbutton_close_icon_action').click()
        return
    except Exception:
        pass
    _click_by_label(page, 'close icon')

def assert_click_close_icon_visible(page, timeout: int = 6000):
    expect(page.smartAI('secnd_close_icon_iconbutton_close_icon_action')).to_be_visible(timeout=timeout)


def click_proceed_to_pay(page):
    try:
        page.get_by_role("button", name='PROCEED TO PAY', exact=True).first.click()
        return
    except Exception:
        pass
    try:
        page.get_by_role("link", name='PROCEED TO PAY', exact=True).first.click()
        return
    except Exception:
        pass
    try:
        page.smartAI('secnd_proceed_to_pay_button_proceed_to_pay_action').click()
        return
    except Exception:
        pass
    _click_by_label(page, 'PROCEED TO PAY')

def assert_click_proceed_to_pay_visible(page, timeout: int = 6000):
    expect(page.smartAI('secnd_proceed_to_pay_button_proceed_to_pay_action')).to_be_visible(timeout=timeout)


def click_terms_and_condition(page):
    try:
        page.get_by_role("button", name='Terms and Condition', exact=True).first.click()
        return
    except Exception:
        pass
    try:
        page.get_by_role("link", name='Terms and Condition', exact=True).first.click()
        return
    except Exception:
        pass
    try:
        page.smartAI('secnd_terms_and_condition_link_terms_and_condition_action').click()
        return
    except Exception:
        pass
    _click_by_label(page, 'Terms and Condition')

def assert_click_terms_and_condition_visible(page, timeout: int = 6000):
    expect(page.smartAI('secnd_terms_and_condition_link_terms_and_condition_action')).to_be_visible(timeout=timeout)


def click_do_s_don_ts(page):
    try:
        page.get_by_role("button", name='Do’s & Don’ts', exact=True).first.click()
        return
    except Exception:
        pass
    try:
        page.get_by_role("link", name='Do’s & Don’ts', exact=True).first.click()
        return
    except Exception:
        pass
    try:
        page.smartAI('secnd_do_s_don_ts_link_dos_donts_action').click()
        return
    except Exception:
        pass
    _click_by_label(page, 'Do’s & Don’ts')

def assert_click_do_s_don_ts_visible(page, timeout: int = 6000):
    expect(page.smartAI('secnd_do_s_don_ts_link_dos_donts_action')).to_be_visible(timeout=timeout)
